    ...
    return (
        <section id="about" style={{ backgroundColor: 'var(--bg-secondary)' }}>
            <div className="container">
                ...
                <div className="glass-card animate-slide-up delay-100" style={{ padding: '40px', fontSize: '1.1rem', color: '#ccc', lineHeight: '1.8' }}>
                    <p style={{ marginBottom: '20px' }}>
                        I am a passionate <strong style={{ color: '#fff' }}>Software Developer</strong> and <strong style={{ color: '#fff' }}>Automation Engineer</strong> with a strong focus on building efficient, scalable solutions.
                    ...
                    <p>
                        Proficient in <strong style={{ color: '#fff' }}>Python</strong>, I specialize in developing tools that integrate with various APIs and deployment pipelines,
